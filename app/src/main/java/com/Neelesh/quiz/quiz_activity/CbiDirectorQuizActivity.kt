...
import com.Neelesh.quiz.constaints_data.CbiDirectorObject
...
class CbiDirectorQuizActivity : AppCompatActivity() , View.OnClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mquestionlist = CbiDirectorObject.getQuestions()
        setQuestion()
