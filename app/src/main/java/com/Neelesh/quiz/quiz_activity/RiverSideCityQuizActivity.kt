...
import com.Neelesh.quiz.constaints_data.CityFounderObject
...
class RiverSideCityQuizActivity : AppCompatActivity(),View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mquestionlist = RiverSideCityObject.getQuestions()
        setQuestion()
