...
import com.Neelesh.quiz.constaints_data.SpaceCentreObject
import com.Neelesh.quiz.constaints_data.state_language_object
import com.Neelesh.quiz.data_class.Question
import com.Neelesh.quiz.result_activity.ResultActivity
import kotlinx.android.synthetic.main.activity_quiz_question.*

class SpaceCentreQuizActivity : AppCompatActivity()  , View.OnClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mquestionlist =SpaceCentreObject.getQuestions()
        setQuestion()
