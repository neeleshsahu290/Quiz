...
import com.Neelesh.quiz.constaints_data.ChifJusticeObject
...
class ChifJusticeQuizActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mquestionlist = ChifJusticeObject.getQuestions()
        setQuestion()
