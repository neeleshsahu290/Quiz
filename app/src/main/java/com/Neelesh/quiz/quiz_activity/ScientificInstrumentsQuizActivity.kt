...
import com.Neelesh.quiz.constaints_data.RiverSideCityObject
import com.Neelesh.quiz.constaints_data.ScientificInstrumentsObject
import com.Neelesh.quiz.data_class.Question
import com.Neelesh.quiz.result_activity.ResultActivity
import kotlinx.android.synthetic.main.activity_quiz_question.*

class ScientificInstrumentsQuizActivity : AppCompatActivity() , View.OnClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mquestionlist = ScientificInstrumentsObject.getQuestions()
        setQuestion()
