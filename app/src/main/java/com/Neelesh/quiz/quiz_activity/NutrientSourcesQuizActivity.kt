...
import com.Neelesh.quiz.constaints_data.NutrientSourceObject
...
class NutrientSourcesQuizActivity : AppCompatActivity() , View.OnClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mquestionlist =NutrientSourceObject.getQuestions()
        setQuestion()
