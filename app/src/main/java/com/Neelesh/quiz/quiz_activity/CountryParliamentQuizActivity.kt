...
import com.Neelesh.quiz.constaints_data.DamsindiaObject
import com.Neelesh.quiz.constaints_data.ParlimantryNamesObject
import com.Neelesh.quiz.data_class.Question
import com.Neelesh.quiz.result_activity.ResultActivity
import kotlinx.android.synthetic.main.activity_quiz_question.*

class CountryParliamentQuizActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mquestionlist = ParlimantryNamesObject .getQuestions()
        setQuestion()
