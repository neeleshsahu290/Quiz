...
import com.Neelesh.quiz.constaints_data.ArmyAdrinalObject
...
class NavyAdrinalQuizActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mquestionlist = ArmyAdrinalObject.getQuestions()
        setQuestion()
