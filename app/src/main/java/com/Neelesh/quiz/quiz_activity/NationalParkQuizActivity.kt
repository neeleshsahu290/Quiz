...
import com.Neelesh.quiz.constaints_data.NationalParkObject
import com.Neelesh.quiz.constaints_data.PalacesInIndiaObject
import com.Neelesh.quiz.data_class.Question
import com.Neelesh.quiz.result_activity.ResultActivity
import kotlinx.android.synthetic.main.activity_quiz_question.*

class NationalParkQuizActivity : AppCompatActivity(),View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mquestionlist = NationalParkObject .getQuestions()
        setQuestion()
