...
import com.Neelesh.quiz.constaints_data.AuditorGeneralOBject
...
class ComptrollerAuditorQuizActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mquestionlist = AuditorGeneralOBject.getQuestions()
        setQuestion()
