...
import com.Neelesh.quiz.constaints_data.FirstMaleObject
import com.Neelesh.quiz.data_class.Question
import com.Neelesh.quiz.result_activity.ResultActivity
import kotlinx.android.synthetic.main.activity_quiz_question.*

class FirstMalequizActivity : AppCompatActivity() , View.OnClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mquestionlist = FirstMaleObject.getQuestions()
        setQuestion()
