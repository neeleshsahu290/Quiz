...
import com.Neelesh.quiz.constaints_data.BookAuthorObject
...
class BookAuthorsQuizActivity : AppCompatActivity() , View.OnClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mquestionlist = BookAuthorObject.getQuestions()
        setQuestion()
