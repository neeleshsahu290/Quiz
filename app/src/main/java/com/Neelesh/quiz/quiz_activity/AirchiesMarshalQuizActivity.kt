...
import com.Neelesh.quiz.constaints_data.AirChifMarsnalObject
...
class AirchiesMarshalQuizActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mquestionlist = AirChifMarsnalObject.getQuestions()
        setQuestion()
