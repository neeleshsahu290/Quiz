...
import com.Neelesh.quiz.constaints_data.AttonyGeneralObject
...
class AtornyGeneralQuizActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mquestionlist = AttonyGeneralObject.getQuestions()
        setQuestion()
