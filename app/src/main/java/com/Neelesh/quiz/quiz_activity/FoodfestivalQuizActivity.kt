...
import com.Neelesh.quiz.constaints_data.FamousTempleObject
import com.Neelesh.quiz.constaints_data.FoodFestivalOBject
import com.Neelesh.quiz.data_class.Question
import com.Neelesh.quiz.result_activity.ResultActivity
import kotlinx.android.synthetic.main.activity_quiz_question.*

class FoodfestivalQuizActivity : AppCompatActivity(), View.OnClickListener  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mquestionlist = FoodFestivalOBject .getQuestions()
        setQuestion()
